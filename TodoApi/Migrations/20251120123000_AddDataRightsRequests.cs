...
{
    /// <inheritdoc />
    public partial class AddDataRightsRequests : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequestedByEmail = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DataRightsRequests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DataRightsRequests_AppUsers_AppUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DataRightsRequests_AppUserId",
